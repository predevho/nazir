...
export const content: AllContent = {
  site: {
    ...
    // 시안에는 `전도서 4:22`로 적혀 있으나 전도서 4장은 16절까지다. 실제 출처는 4:12.
    joinVerseRef: '전도서 4:12',
    joinIntro:
      '<나지르>는 지금 무대 위에 오르기 위해 하나씩 준비되고 있습니다.\n연습과 무대 제작, 의상 및 소품, 음향과 조명, 홍보와 티켓 제작까지\n한 편의 공연이 완성되기 위해서는 여러 손길이 필요합니다.\n기도와 응원, 마음이 닿는 후원으로 <나지르>의 여정에 함께해 주세요.',
    prayerNote: '<나지르>가 필요한 이들에게 닿을 수 있도록, 기도로 함께해 주세요.',
    supportIntro:
